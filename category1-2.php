...
<header>
   ...
   <div class="product_view">
        <h2>120L 디깅용 앞문 열림창 리빙 하우스 /자연주의 케이지용 리빙 하우스</h2>
        <table>
            <colgroup>
            ...
            <tr>
                <th>결제금액</th>
                <td class="total"><b>   55,000</b>원</td>
            </tr>
            </tbody>
        </table>
        <div class="img">
            <img src="https://hamtopia.com/web/product/big/201808/7b3cb5edab855ec64576dd33e4fcf17f.jpg" alt="">
        </div>
        <div class="btns">
