...
<body>
   ...
   <div class="product_view">
        <h2>[모모팜] 슬림와일드 아스펜 베딩 1.2Kg(중포장)</h2>
        <table>
            <colgroup>
            ...
            <tr>
                <th>결제금액</th>
                <td class="total"><b>               13,000</b>원</td>
            </tr>
            </tbody>
        </table>
        <div class="img">
            <img src="https://hamtopia.com/web/product/big/20200403/462aafe0ca2bcc9fb6c17d2a362559e4.jpg" alt="">
        </div>
        <div class="btns">
