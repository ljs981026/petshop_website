...
<body>
   ...
   <div class="product_view">
        <h2>JRS3-4 (shaving)베딩 500g / 1kg</h2>
        <table>
            <colgroup>
            ...
            <tr>
                <th>결제금액</th>
                <td class="total"><b>               1,6000</b>원</td>
            </tr>
            </tbody>
        </table>
        <div class="img">
            <img src="https://hamtopia.com/web/product/big/201608/29_shop1_810279.jpg" alt="">
        </div>
        <div class="btns">
