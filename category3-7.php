...
<body>
    ...
    <form name="category2-2" method="post" action="buy.php" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                <th>결제금액</th>
                <td class="total"><b>   11,500</b>원</td>
            </tr>
            </tbody>
        </table>
        <div class="img">
            <img src="https://hamtopia.com/web/product/big/202110/c441e95a6ef20d60c9ae5b9eae68f829.jpg" alt="">
        </div>
        <div class="btns">
